    ...
    @endif
        <form action="{{ route('roles.store') }}" method="post">
            ...
            <div>
                ...
                <input type="text" name="role_name" id="product-name-ar" class="mt-1 block w-full p-2 border border-gray-300 rounded-md dark:bg-gray-600 dark:border-gray-500 dark:text-gray-100">
            </div>
